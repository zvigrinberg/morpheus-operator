...
# redhat.com/morpheus-operator-bundle:$VERSION and redhat.com/morpheus-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= redhat.com/morpheus-operator
...
bundle: manifests kustomize operator-sdk ## Generate bundle manifests and metadata, then validate generated files.
	...
	cd config/manager && $(KUSTOMIZE) edit set image controller=$(IMG) && $(KUSTOMIZE) edit set annotation morpheus-jupyter-version:"$(VERSION)"
